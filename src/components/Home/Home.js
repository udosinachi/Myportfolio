                ...
                <Div2>
                   <div className='div1'>
                        <A>
                            ...
                            <button className='button1'><a href='https://en.wikipedia.org/wiki/HTML' target='_blank' ref='noopener noreferrer'>Learn more</a></button>
                        </A><br/>
                        <A>
                            ...
                            <button className='button2'><a href='https://en.wikipedia.org/wiki/Cascading_Style_Sheets' target='_blank' ref='noopener noreferrer'>Learn more</a></button>
                        </A>
                        <A>
                            <p className='p3'>() =></p>
                            <h1>JavaScript</h1>
                            ...
                            <button className='button3'><a href='https://en.wikipedia.org/wiki/JavaScript' target='_blank' ref='noopener noreferrer'>Learn more</a></button>
                        </A><br/>
                   </div>
                   <div className='div1'>
                        <A>
                            ...
                            <button className='button4'><a href='https://reactjs.org/' target='_blank' ref='noopener noreferrer'>Learn more</a></button>
                        </A>
                        <A>
                            ...
                            <button className='button5'><a href='https://react-redux.js.org/' target='_blank' ref='noopener noreferrer'>Learn more</a></button>
                        </A><br/>
                        <A>
                            ...
                            <button className='button6'><a href='https://reacttraining.com/react-router/' target='_blank' ref='noopener noreferrer'>Learn more</a></button>
                        </A><br/>
                   </div>
                </Div2>           
            </Div>
